...
MODEL_PATHS: dict[ModelName, str] = {
    "clip-vit-b-32-image":CLIP_IMAGE_MODEL_PATH,
    'dinov2-small': DINO_V2_SMALL_MODEL_PATH,
    'clip-vit-b-32-text': CLIP_TEXT_MODEL_PATH,
    'all-minilm-l6-v2': MINILM_MODEL_PATH,
}
